...
(cd "$output" && shasum -a 256 TagentraPM3Core.xcframework.zip TagentraPM3Core-source.tar.gz TagentraPM3Core-build.json TagentraPM3Core-io-audit.json LICENSE THIRD_PARTY_NOTICES.md > SHA256SUMS)
